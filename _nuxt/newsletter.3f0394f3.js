...
<body>
            ...
            <tr>
                <td align="center" valign="top" id="bodyCell">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                        ...
                        <tr>
                            <td valign="top" id="templateBody">`;return t}function q(t){var i=`<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                ...
                </table>`;return i}function W(t){var i=`<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnImageCardBlock" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardBottomContent" width="100%" style="background-color: #000;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%; border: 1px solid #333">
                    <tbody>`;return t.media&&(i+=`                        <tr>
                            <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top: 0px;padding-right: 0px;padding-bottom: 0;padding-left: 0px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                <a href="`+g(t)+`" title="" class="" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                    <img alt="`+t.media[0].alt_text+' " src="'+t.media[0].large_image+` " width="564" style="max-width: 600px;border: 0;height: auto;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;vertical-align: bottom;" class="mcnImage">
                                </a>
                            </td>
                        </tr>`),i+=`
                        <tr>
                            <td class="mcnTextContent" valign="top" style="padding: 9px 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;line-height: 150%;" width="546">
                                <h2 class="null" style="display: block;margin: 0;padding: 0;color: #ffffff;font-family: Helvetica;font-size: 22px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;"><a href="`+g(t)+'" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #FFCD00;font-weight: normal;text-decoration: underline;">'+t.title+"</a></h2>"+S(t)+"<br />"+P(t)+' <a href="'+g(t)+`" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #FFCD00;font-weight: normal;text-decoration: underline;">More...</a>
    ...
    </table>`,i}function Y(t){var i=` <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                    <tbody class="mcnTextBlockOuter">
                        <tr>
                            <td valign="top" class="mcnTextBlockInner" style="padding-top: 9px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                <!--[if mso]>
                            ...
                            <![endif]-->
                    ...
                    </table>`;return i}function X(t){var i=`<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnBoxedTextBlock" style="min-width:100%;">
                                    <!--[if gte mso 9]>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td valign="top" class="mcnTextContent" style="padding: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: left;">
                                                                                <h2 class="null"><a href="`+g(t)+'" target="_blank">'+t.title+`</a></h2>
                                                                                `+S(t)+"<br />"+P(t)+`

                                                                                 <a href="`+g(t)+`" target="_blank">More...</a>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                ...
                                </table>`;return i}function K(){var t=`</td>
                        </tr>
                        <tr>
...
`;return t}function S(t){var i=[];return i=V(t.event_instances),i.length>0?i[0]:"No upcoming dates."}function P(t){var i="";return t.virtual?i="Virtual Event":(t.room_number&&(i=t.room_number+", "),t.location_name&&(i+=t.location_name)),i}const $={class:"container"},J=e("div",{class:"row"},[e("div",{class:"col-lg-12"},[e("h1",{class:"mt-6"},"After Class Newsletter Creator")])],-1),Q={class:"row"},Z={class:"col-lg-6"},tt=e("label",{for:"header-text",class:"d-block"},"Header Text",-1),et=["for"],at=["id","name","onUpdate:modelValue"],it=e("option",{value:"0",label:"(No event)"},"0",-1),nt=["value","label"],ot=["for"],lt=["id","name","onUpdate:modelValue"],dt=e("option",{value:"0",label:"(No event)"},"0",-1),rt=["value","label"],st=e("label",{for:"footer-text",class:"d-block"},"Footer Text",-1),ct={class:"col-lg-6"},pt=["srcdoc"],mt={class:"row"},bt={class:"col-lg-12"},gt=e("label",{for:"outputHTML"},"Copy/Paste HTML:",-1),wt={__name:"newsletter",async setup(t){let i,B;const h=([i,B]=D(()=>R()),i=await i,B(),i),f=m(""),v=m(""),C=m(""),k=m([0,0,0,0,0,0,0,0,0]),T=m([0,0,0,0,0,0,0,0,0]);L(()=>{s()});function s(){var r=[],n=[];k.value.forEach(function(o,l){o==0?r[l]=null:r[l]=F(h,o)}),T.value.forEach(function(o,l){o==0?n[l]=null:n[l]=F(h,o)}),f.value=M(r,n)}function M(r,n){var o=G();return o+=q(v.value),r.forEach(function(l,x){l!=null&&(o+=W(l.event))}),n.forEach(function(l,x){l!=null&&(o+=X(l.event))}),o+=Y(C.value),o+=K(),o}function F(r,n){var o=r.value.events.find(function(l,x,a){if(l.event.id==this)return l.event},n);return o}return(r,n)=>{const o=O,l=N,x=U;return c(),p("div",null,[I(l,null,{default:H(()=>[I(o,null,{default:H(()=>[A("Newsletter Creator")]),_:1})]),_:1}),I(x),e("div",$,[J,e("div",Q,[e("div",Z,[e("form",null,[tt,b(e("textarea",{id:"header-text","onUpdate:modelValue":n[0]||(n[0]=a=>v.value=a),onInput:s,class:"form-control",rows:"8"},null,544),[[_,v.value]]),(c(),p(u,null,y(8,a=>e("div",{key:a},[e("label",{for:"featured-event-"+a},"Featured Event "+w(a)+":",9,et),b(e("select",{id:"featured-event-"+a,name:"featured-event-"+a,class:"form-select form-select-sm","onUpdate:modelValue":d=>k.value[a]=d,onChange:s},[it,(c(!0),p(u,null,y(E(h).events,d=>(c(),p("option",{onClick:n[1]||(n[1]=z=>s(z.target.value)),key:d.event.id,value:d.event.id,label:d.event.title},w(d.event.id),9,nt))),128))],40,at),[[j,k.value[a]]])])),64)),(c(),p(u,null,y(8,a=>e("div",{key:a},[e("label",{for:"nonfeatured-event-"+a},"Nonfeatured Event "+w(a)+":",9,ot),b(e("select",{id:"nonfeatured-event-"+a,name:"nonfeatured-event-"+a,class:"form-select form-select-sm","onUpdate:modelValue":d=>T.value[a]=d,onChange:s},[dt,(c(!0),p(u,null,y(E(h).events,d=>(c(),p("option",{onClick:n[2]||(n[2]=z=>s(z.target.value)),key:d.event.id,value:d.event.id,label:d.event.title},w(d.event.id),9,rt))),128))],40,lt),[[j,T.value[a]]])])),64)),st,b(e("textarea",{id:"footer-text","onUpdate:modelValue":n[3]||(n[3]=a=>C.value=a),onInput:s,class:"form-control",rows:"8"},null,544),[[_,C.value]])])]),e("div",ct,[e("iframe",{srcdoc:f.value,width:"100%",height:"1000"}," ",8,pt)])]),e("div",mt,[e("div",bt,[gt,b(e("textarea",{readonly:"",rows:"40",cols:"50",id:"outputHTML",class:"form-control output-html",onClick:n[4]||(n[4]=a=>a.target.select()),"onUpdate:modelValue":n[5]||(n[5]=a=>f.value=a)},`
          `,512),[[_,f.value]])])])])])}}};export{wt as default};
