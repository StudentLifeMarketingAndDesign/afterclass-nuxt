<template>
  <div class="iowa-bar container-fluid iowa-bar--narrow iowa-bar--dark-header" data-uids-header>
    <div class="iowa-bar__container container-xl">
      <div class="uids-logo uids-logo--tab d-flex align-items-center">
        <a href="https://www.uiowa.edu">
          <div class="sr-only">The University of Iowa</div>
          <svg xmlns="http://www.w3.org/2000/svg" class="uids-logo__icon" aria-labelledby="logo-header" role="img"
      ...
      <nav aria-labelledby="uids-toplinks" class="uids-toplinks">
        ...
        <ul class="nav uids-toplinks__menu">
          <li class="nav-item parent-site-name uids-toplinks__item mx-2">
            <a href="https://studentlife.uiowa.edu" class="uids-toplinks__link">Division of Student Life</a>
          </li>
        </ul>
      </nav>
    </div>
